...
3. **LOCATE** — GPS, EXIF, Nominatim (wired by the backend)
4. **CHECK** — duplicate lookup (wired by the backend)
5. **ACT** — Mistral agent produces category, priority, municipal report
